<section class="fslider">
		<div class="slider">
		    ...
		    <li>
		        ...
		        <h3 style="font-size: 3rem !important; font-style: bold !important; font-family: 'Bree Serif', serif;">NORRITURE</h3>  
		        <h5 class="light black-text text-lighten-3"><strong>Good Food Brings Good People Together!</strong></h5>  
		      </div>  
		    </li>
