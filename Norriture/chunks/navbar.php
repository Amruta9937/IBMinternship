<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">Norriture</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/Norriture" class="hvr-grow">Home</a></li>
		        <li><a href="/Norriture/about-norriture.php" class="hvr-grow">About Us</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/Norriture">Home</a></li>
	        <li><a href="/Norriture/about-Norriture.php">About Us</a></li>
